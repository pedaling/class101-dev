...
2. date
    작성한 날짜.
3. thumbnail
    포스트 썸네일. 공유하기 할때도 사용된다.
4. description
    포스트에 대한 설명 없으면 본문을 300자 잘라서 사용합니다.
5. author
    작성한 사람 이름. utils의 authors에 정의되어있어야함 (수정예정)
6. tags
    해당 포스트가 가지는 키워드. 없으면 [] 넣어주세요.

개행은 문장 끝 스페이스 2개를 붙이면 할 수 있음.

엔터는 엔터 2개.

TOC는 자동으로 붙이니까 안넣어도 ㄱㅊ Header 순서만 잘 넣어주세요.

    
썸네일은 thumbnails에 넣으신 후 사용해주세요. 상대 경로로 하면 안먹음 ㅠㅠ


이미지는 같은 폴더에 붙이신 후
![](Untitled-e78fee7b-e454-40e4-a518-78abead5c80e.png) 요렇게 쓰면 됩니다.
